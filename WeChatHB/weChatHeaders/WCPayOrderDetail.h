...
@class NSArray, NSMutableArray, NSString, WCPayAddressInfo, WCPayExposureInfo, WCPayOrderDetailActivityInfo, WCPayOrderDetailRemarksInfo, WCPayOrderDetailSubscribeBrandInfo, WCPayOrderDetailTinyAppInfo, WCPayTextInfo;
