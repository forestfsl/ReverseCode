...
+ (void)reportMktCardHomePageDataReportWithMchType:(unsigned int)arg1 mchID:(id)arg2 cardIndex:(unsigned int)arg3 cardID:(id)arg4 reportScene:(unsigned int)arg5;
