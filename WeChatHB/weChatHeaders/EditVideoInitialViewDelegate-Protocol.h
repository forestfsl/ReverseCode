...
@class EditVideoAttr, NSString, RecommendedMusicInfo, UIImage, UIViewController;
...
- (void)onChooseVideoBGMDoneWithRequestId:(unsigned long long)arg1 andMusicIndex:(long long)arg2 andMusicInfo:(RecommendedMusicInfo *)arg3 andPath:(NSString *)arg4;
