...
@class FavClickStreamHelper, FavDataItemWrap, FavForwardLogicController, FavoritesItem, FavoritesItemDataField, NSString;

@interface FavMoviePlayerController : MMMoviePlayerController <MMWebViewDelegate, FavClickStreamHelperDelegete, FavTagViewDelegate, FavForwardLogicDelegate>
{
