...
@interface WARemoteDebugger : NSObject <WARemoteDebugChannelDelegate, PBMessageObserverDelegate, WCStateMachineDelegate, WARemoteDebugSendQueueDelegate, WARemoteDebugRecvQueueDelegate, WAJSCoreServiceRemoteDelegate>
{
