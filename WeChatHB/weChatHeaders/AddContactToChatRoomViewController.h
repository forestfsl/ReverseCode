...
@interface AddContactToChatRoomViewController : MMUIViewController <WCActionSheetDelegate, WAMsgBrowserDataLogicDelegate, IStrongNotificationMgrExt, ChatRoomMemberGridViewDelegate, IContactMgrExt, CreateChatLogicDelegate, contactInfoDelegate, UIAlertViewDelegate>
{
    CContact *m_contact;
...
- (void)showWeAppMsg;
- (void)makeWeAppMsgListCell:(id)arg1 cellInfo:(struct WCTableViewNormalCellManager *)arg2;
