...
@class EmoticonBoardView, MMBadgeView, MMEmoticonView, MMGrowTextView, MMQuickSendEmoticonView, MMTransparentButton, NSString, NSURL, RecordView, SelectAttachmentView, SelectAttachmentViewController, ShortVideoToolbar, UIButton, UIView, VoiceInputView, WASendSessionMsgView;
...
@interface MMInputToolView : MMUIView <MMQuickSendEmoticonViewDelegate, WASendSessionMsgViewDelegate, EmoticonDescMgrExt, UITextViewDelegate, ISysCallCheckExt, WCActionSheetDelegate, MMGrowTextViewDelegate, MMTransparentButtonDelegate, SelectAttachmentViewControllerDelegate, VoiceInputViewDelegate, EmoticonBoardViewDelegate, BaseEmoticonViewDelegate, IRecordPermissionCheckExt, ShortVideoBarDelegate>
{
    ...
    MMBadgeView *_expressionButtonBadgeView;
...
@property(retain, nonatomic) MMBadgeView *expressionButtonBadgeView; // @synthesize expressionButtonBadgeView=_expressionButtonBadgeView;
