...
- (void)onNumberOfSectionsInTableView:(id)arg1;
...
- (void)recodeAllAppmsgExposureInfoForVisibleCells;
- (void)recodeAppmsgExposureInfoForMessageWrap:(id)arg1;
- (_Bool)isAppmsgSupportExposure:(id)arg1;
- (void)handleAppmsgExposureOrPreload;
