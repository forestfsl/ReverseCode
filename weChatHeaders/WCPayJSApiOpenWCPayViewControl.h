...
@class JSEvent, NSString, WCPayBalanceFetchMoneyControlLogic, WCPayF2FJSApiAuthenticationControlLogic, WCPayF2FReceiveDetailControlLogic, WCPayJSApiAuthenticationControlLogic, WCPayJumpC2CMessageJsapiLogic, WCPayLQTDepositControlLogic, WCPayLQTDetailControlLogic, WCPayT2BCDetailControlLogic, WCPayT2BCTransferControlLogic;

@interface WCPayJSApiOpenWCPayViewControl : WCPayControlLogic <WCPaySecuritySettingViewControllerDelegate, WCPayLQTDetailControlLogicDelegate, HoneyPayHomeControlLogicDelegate, HoneyPayPayerDetailControlLogicDelegate, WCBaseControlMgrExt>
{
    JSEvent *m_jsEvent;
