...
@interface WCPayLogicMgr : MMService <MMTipsViewControllerDelegate, ILinkEventExt, MMWebViewDelegate, MMResourceMgrExt, MMImageLoaderObserver, MMKernelExt, MMService, WCPayNetworkHelperDelegate, MMPackageDownloadMgrExt, IMsgExt, IAutoVerifySMSExt, IClearDataMgrExt, INewABTestMgrExt>
{
