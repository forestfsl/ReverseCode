...
@class CShakeChecker, FavClickStreamHelper, MMAnimationTipView, MMMusicInfo, MMMusicPageView, MMMusicPlayerModeTipView, MMScrollActionSheet, MMScrollView, MMTipsViewController, MPVolumeView, NSMutableArray, NSString, SendAppMsgHandler, UIButton, UIImageView;

@interface MMMultipleMusicViewController : MMUIViewController <WCActionSheetDelegate, ShareUploadTaskConfirmLogicHelperDelegate, SendAppMsgHandleDelegate, UIScrollViewDelegate, MMScrollActionSheetDelegate, MMMusicPageViewDelegate, ShakeCheckerDelegate, IMusicPlayerExt, MMTipsViewControllerDelegate, FavClickStreamHelperDelegete>
{
