...
@class GPUImageCropFilter, GPUImageOutput<GPUImageInput>, MCDataOutput, MCKeyFilterManager, MCMovieWriterV2, MCOrientationFilter, MCTmplItem, MCWatermarkFilter, MyCamGPUFilter, NSArray, NSDictionary, NSObject<GPUImageInput>, NSString, UIImageOrientationFilter;
