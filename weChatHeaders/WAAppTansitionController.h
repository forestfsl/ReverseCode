...
{
    _Bool _isSimulatedNativePushAnimation;
...
@property(nonatomic) _Bool isSimulatedNativePushAnimation; // @synthesize isSimulatedNativePushAnimation=_isSimulatedNativePushAnimation;
