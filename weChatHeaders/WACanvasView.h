...
@class CAEAGLLayer, EAGLContext, NSCondition, NSMutableArray, NSMutableDictionary, NSMutableSet, UIColor, WACanvasLayoutHelper;
...
@interface WACanvasView : UIView
{
    ...
    WACanvasLayoutHelper *_layoutHelper;
...
- (void)subThreadDrawImage:(id)arg1;
- (void)realMainThreadDrawImage:(id)arg1;
- (void)mainThreadDrawImage:(id)arg1;
