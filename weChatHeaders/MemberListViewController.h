...
@class MMLoadingView, MMSearchBar, MMTableView, NSObject<MemberDataLogicProtocol>, NSString, UILabel, UIView;

@interface MemberListViewController : MMSearchBarDisplayController <UITableViewDataSource, UITableViewDelegate, MMSearchBarDelegate, UIAlertViewDelegate>
{
