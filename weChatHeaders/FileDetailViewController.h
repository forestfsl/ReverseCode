...
@class FileDetailLogicController, MMCircleProgressView, MMMPMoviePlayerController, NSString, ShareDataToOpenSDKController, UIButton, UIDocumentInteractionController, UIImageView, UILabel, UITapGestureRecognizer, WCActionSheet, WKWebView;
