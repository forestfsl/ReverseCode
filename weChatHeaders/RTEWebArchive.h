...
@class NSArray, RTEWebResource;

@interface RTEWebArchive : NSObject
{
    RTEWebResource *_mainResource;
...
@property(retain, nonatomic) RTEWebResource *mainResource; // @synthesize mainResource=_mainResource;
- (void).cxx_destruct;
- (id)data;
