...
@class FTSVoiceSearchBarController, MFBackupBtn, MFBannerBtn, MFFavDetailBtn, MFMigrationBtn, MFMusicPlayBtn, MFPublicWifiBtn, MFPushBannerLogic, MFPushSystemMsgLogic, MFWebMMBtn, MFWebViewVCKeepHoldBtn, NSMutableArray, NSString;
