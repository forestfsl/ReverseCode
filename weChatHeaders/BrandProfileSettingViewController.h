...
- (void)makeClearMessageCell:(id)arg1 cellInfo:(struct WCTableViewNormalCellManager *)arg2;
- (void)clickComplaintCell:(id)arg1;
- (void)makeComplaintCell:(id)arg1 cellInfo:(struct WCTableViewNormalCellManager *)arg2;
