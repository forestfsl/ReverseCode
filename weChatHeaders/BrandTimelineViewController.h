...
@class BTHeaderItemCellView, BrandArticleSearchController, BrandTimelineNotifyLogic, BrandTimelineReportLogic, CContact, CMessageWrap, MMTableView, MMTimer, NSIndexSet, NSMutableArray, NSString, UIButton, UIView, WCTimeLineFooterView;
