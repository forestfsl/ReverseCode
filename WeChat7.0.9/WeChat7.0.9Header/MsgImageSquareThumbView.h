...
@class AppFileNodeProgressView, CMessageWrap, MMWebImageView, NSString, SimpleImgInfo, UIActivityIndicatorView, UIImageView, UILabel, UIProgressView, UIView, YYImage;
