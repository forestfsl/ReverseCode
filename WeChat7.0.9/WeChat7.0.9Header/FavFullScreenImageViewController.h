...
@class EditImageForwardAndEditLogicController, FavClickStreamHelper, MMFullScreenItemView, MMScrollView, NSMutableArray, NSString, ScanQRCodeLogicController, SimpleImgInfo, UIView, WCActionSheetWithScanWXCode;
