...
@class CAGradientLayer, EmoticonBoardView, MMGrowTextView, MMUIButton, MMUILabel, NSMutableArray, NSString, UIButton, UILabel, UITableView, UIView, WCInputController, WCStoryComment, WCStoryDataItem, WCStoryPreviewReportObj;
@protocol WCStoryCommentOthersViewControllerDelegate;

@interface WCStoryCommentOthersViewController : MMUIViewController <UITableViewDataSource, UITableViewDelegate, WCStoryFacadeExt, WCStoryFriendCommmentHeadCellDelegate, MMTipsViewControllerDelegate, InputControllerDelegate>
{
