...
@class EmotionButtonWithClickState, LoginUserCellViewModel, MMUILabel, UIButton, UIImageView, UILabel, WXGDotDotDotLabel;

@interface LoginUserCellView : UIView
{
    LoginUserCellViewModel *_viewModel;
    EmotionButtonWithClickState *_backgroundBtn;
...
@property(retain, nonatomic) EmotionButtonWithClickState *backgroundBtn; // @synthesize backgroundBtn=_backgroundBtn;
