...
#import "WCEditVideoLogicControlDelegate-Protocol.h"

@class EditImageIntialView, EditVideoLogicItem, FavClickStreamHelper, MMAsset, MMAssetPickerSendButton, MMAssetSelectCheckButton, MMAssetSelectedCollectionView, MultiImageScrollView, NSMutableDictionary, NSString, UIActivityIndicatorView, UIButton, UIImageView, UILabel, UIView, WCEditVideoLogicControl;
@protocol MMImagePickerControlCenter, MMImagePreviewBrowserControllerDataSource, MMImagePreviewBrowserControllerDelegate;

@interface MMImagePreviewBrowserController : WCDragToCloseViewController <EditVideoLogicItemDelegate, WCEditVideoLogicControlDelegate, EditImageInitialViewDelegate, MMAssetPickerBrowserViewDelegate, MMAssetSelectedCollectionViewDelegate, SightLocalVideoProcessingViewControllerDelegate, MultiImageScrollViewDelegate, WCActionSheetDelegate>
{
    ...
    MMAsset *__editAsset;
    WCEditVideoLogicControl *_editVideoLogicControl;
...
@property(retain, nonatomic) WCEditVideoLogicControl *editVideoLogicControl; // @synthesize editVideoLogicControl=_editVideoLogicControl;
