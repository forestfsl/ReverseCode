...
@class MMTimer, MMUIButton, MMUIImageView, MMUILabel, MMWebImageView, MMWebViewController, MPLandingVideoDotAdWebViewPosInfo, MPLandingVideoErrView, MPLandingVideoOversizeTipsView, MPPlayerHttpMediaWrap, NSMutableArray, NSString, UIImage, UIImageView, UIPanGestureRecognizer, UISlider, UITapGestureRecognizer, UITopTouchView, UIView, WAScreenBrightnessStateView, WCNetworkMediaSlider, WCPlayerPlayArgs, WCPlayerView;
...
@interface MPLandingVideoPlayerView : WCPlayerControlView <UIGestureRecognizerDelegate, MPLandingVideoErrViewDelegate, MMWebImageViewDelegate>
{
    ...
    struct CGRect _thumbImageViewRect;
    struct CGAffineTransform _videoTransform;
}

@property(nonatomic) struct CGRect thumbImageViewRect; // @synthesize thumbImageViewRect=_thumbImageViewRect;
...
@property(retain, nonatomic) UIView *dotAdView; // @synthesize dotAdView=_dotAdView;
...
- (void)clearDotAdView;
- (void)setDotAdView:(id)arg1 posInfo:(id)arg2;
...
- (void)setVideoThumbImageViewRect:(struct CGRect)arg1;
