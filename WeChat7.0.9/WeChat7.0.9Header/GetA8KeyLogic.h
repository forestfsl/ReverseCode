...
@interface GetA8KeyLogic : MMObject <WCPayLogicMgrExt, IJumpEmoticonDetailCgiDelegate, ExtraDeviceLoginMgrExt, IScanBookMgrExt, WCNewCardDetailViewControllerDelegate, ContactSearchLogicDelegate, PBMessageObserverDelegate, IWCProductExt, WCProductDetailViewControllerDelegate, IWCDeviceBrandMgrExt, WCBaseControlMgrExt>
{
