...
@class EmotionButtonWithClickState, UIImageView, UILabel;
...
@interface RelatedEmoticonCollectionFooterView : UICollectionReusableView
{
    ...
    EmotionButtonWithClickState *_button;
...
@property(retain, nonatomic) EmotionButtonWithClickState *button; // @synthesize button=_button;
