...
@class CADisplayLink, MMWebImageView, NSMutableArray, NSObject, NSString, NSURLRequest, RCDraggableButton, UILabel, UIView, WAGameActionSheet, WAGameCapsuleView, WAGameRollProgressView, WAOpenGLView, YYWAWebView;
@protocol OS_dispatch_queue, WAGameContextDelegate, WAGameKeyboardDelegate;

@interface WAGameViewController : WAWebViewController <WAGameActionSheetDelegate, WAOpenGLViewDelegate, WABindingDelegate, YYWebViewDelegate, MMWebImageViewDelegate, WAWebViewMutiFuncMenuViewDelegate>
{
