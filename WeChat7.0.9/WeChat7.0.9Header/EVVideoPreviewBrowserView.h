...
@interface EVVideoPreviewBrowserView : MMUIScrollView <IMMAssetICloudExt, SightAssetPreviewViewDelegate, EditVideoLogicItemExt, WCEditVideoLogicControlExt, UIScrollViewDelegate>
{
    NSURL *_outputUrl;
