...
@interface WCMyDeviceInfoAssist : MMObject <WCActionSheetDelegate, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate, WCDeviceNameEditConfirmViewDelegate>
{
