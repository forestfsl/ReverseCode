...
@class MMMultiSelectedContactDisplayView, MMNewMultiSelectContactsLogicController, MMTableView, MMUILabel, MMUIView, NSString, UIButton, UIImage, UIImageView, UITextField;
