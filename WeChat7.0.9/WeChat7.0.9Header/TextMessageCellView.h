...
@class MMInputMsgReferView, MMTipsViewController, NSArray, NSString, NavigateLogicController, RichTextView, TextFloatViewController, TextMessageViewModel, UIActivityIndicatorView, UIButton, UIImageView, UILabel, UIView, WCUIActionSheet;

@interface TextMessageCellView : CommonMessageCellView <ILinkEventExt, RichTextLayoutDelegate, WCActionSheetDelegate, MMTipsViewControllerDelegate, TextFloatPreviewDelegate, ITranslateMsgMgrExt, IMsgRevokeExt, IMsgExt, MMInputMsgReferDelegate, MMRichTextCoverViewDelegate, MMRTCMenuEventDelegate>
{
