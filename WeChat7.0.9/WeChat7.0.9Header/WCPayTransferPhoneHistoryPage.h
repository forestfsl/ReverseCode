...
@class MMRefreshTableFooterView, MMTableView, NSString, TransferPhoneGetHisRcvrsResp, UIActivityIndicatorView, UILabel, UIView, WCPayCss;
...
@property(retain) UIActivityIndicatorView *indicatorView; // @synthesize indicatorView=_indicatorView;
