...
@interface FTSWebSearchResultWAWidgetCell : FTSWebSearchBaseResultTableViewCell <WAAppCanvasWrapperViewDelegate, UIGestureRecognizerDelegate, WSActionSheetDelegate, IWAWidgetLocalSearchExt>
{
    ...
    MMUIButton *_leftSwitchButton;
    MMUIButton *_rightSwitchButton;
...
@property(retain, nonatomic) MMUIButton *rightSwitchButton; // @synthesize rightSwitchButton=_rightSwitchButton;
@property(retain, nonatomic) MMUIButton *leftSwitchButton; // @synthesize leftSwitchButton=_leftSwitchButton;
