...
@class BrandMpVideoReporter, CAGradientLayer, CMessageWrap, EditImageForwardAndEditLogicController, ForwardMessageLogicController, ImageScrollView, MMProgressViewEx, MMTimer, MMToastViewController, MMUIButton, MsgImgDataLogic, MsgImgFullScreenContainer, MsgImgPreviewData, NSArray, NSMutableDictionary, NSMutableSet, NSOperationQueue, NSString, OCRTransReport, ScanQRCodeLogicController, ShareDataToOpenSDKController, SightIconView, UIActivityIndicatorView, UIButton, UIImage, UIImageView, UILabel, UIView, WCActionSheetWithScanWXCode;
...
- (id)initWithMsgWrap:(id)arg1 originFrame:(struct CGRect)arg2 soundable:(_Bool)arg3 snapshotView:(id)arg4 needEdit:(_Bool)arg5 isShowSingleMsg:(_Bool)arg6 translateImg:(id)arg7 eScene:(unsigned long long)arg8;
