...
@class CMessageWrap, EmoticonBoardView, MMEmoticonView, MMGrowTextView, MMInputMsgReferView, MMQuickSendEmoticonView, MMTransparentButton, NSString, NSURL, RecordView, RelatedEmoticonHalfScreenViewController, SelectAttachmentView, SelectAttachmentViewController, SolitaireTipsView, UIButton, UIImpactFeedbackGenerator, UIView, VoiceInputView, WASendSessionMsgView;
