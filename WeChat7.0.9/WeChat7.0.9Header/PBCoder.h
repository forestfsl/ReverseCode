...
+ (id)greedyDecodeContainerOfClass:(Class)arg1 withValueClass:(Class)arg2 fromData:(id)arg3;
...
- (id)decodeOneDictionaryOfValueClass:(Class)arg1 orValueCType:(int)arg2 ignoreSize:(_Bool)arg3 greedy:(_Bool)arg4;
- (id)decodeOneSetOfValueClass:(Class)arg1 orValueCType:(int)arg2 ignoreSize:(_Bool)arg3 greedy:(_Bool)arg4;
- (id)decodeOneArrayOfValueClass:(Class)arg1 orValueCType:(int)arg2 ignoreSize:(_Bool)arg3 greedy:(_Bool)arg4;
