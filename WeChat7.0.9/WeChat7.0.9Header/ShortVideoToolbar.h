...
@interface ShortVideoToolbar : MMUIView <MonoServiceLogicExt, EditVideoLogicItemDelegate, MMImageCropperDelegate, UITextFieldDelegate, EditImageInitialViewDelegate>
{
    _Bool m_isActive;
    double m_topPositon;
