...
+ (id)realMakeImageWithColor:(id)arg1 size:(struct CGSize)arg2 cornerRadius:(double)arg3 isResizable:(_Bool)arg4 resizeCapInsets:(struct UIEdgeInsets)arg5;
+ (id)imageWithColor:(id)arg1 size:(struct CGSize)arg2 cornerRadius:(double)arg3 isResizable:(_Bool)arg4 resizeCapInsets:(struct UIEdgeInsets)arg5;
