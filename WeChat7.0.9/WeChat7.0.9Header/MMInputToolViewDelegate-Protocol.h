...
@class AudioRecorderUserData, CEmoticonWrap, CMessageWrap, EditImageAttr, EditVideoAttr, MMUIViewController, MsgSendOpEntry, NSArray, NSData, NSString, NSURL, ServiceAppData, SolitaireObj, UIImage;
