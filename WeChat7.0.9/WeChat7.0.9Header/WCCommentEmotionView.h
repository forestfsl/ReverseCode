...
@class NSString, SnsEmojiInfoObj, UIActivityIndicatorView, UIImageView;
@protocol WCCommentEmotionViewDelegate;

@interface WCCommentEmotionView : MMUIButton <IStoreEmotionSingleDownloadMgrExt>
{
    _Bool _isStatic;
    double _maxLength;
...
- (void)showEmotionWithData:(id)arg1;
