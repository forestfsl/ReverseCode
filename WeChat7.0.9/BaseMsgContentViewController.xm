...
- (WCStoryReportUtil *)reportUtil { %log; WCStoryReportUtil * r = %orig; HBLogDebug(@" = %@", r); return r; }
...
- (__weak MMInputMsgReferView *)msgReferView { %log; __weak MMInputMsgReferView * r = %orig; HBLogDebug(@" = 0x%x", (unsigned int)r); return r; }
...
- (_Bool)onRecordWillStopWhenAppWillTerminate { %log; _Bool r = %orig; HBLogDebug(@" = %d", r); return r; }
- (id)CancelRecordingAndTransVoiceWithLanguage:(unsigned int)arg1 { %log; id r = %orig; HBLogDebug(@" = %@", r); return r; }
- (_Bool)IsRecording { %log; _Bool r = %orig; HBLogDebug(@" = %d", r); return r; }
...
- (void)shouldShowInputBar:(_Bool *)arg1 { %log; %orig; }
...
- (void)AsyncSendMessage:(id)arg1 replyingMsg:(id)arg2 { %log; %orig; }
...
- (_Bool)jumpMPVideoView:(id)arg1 url:(id)arg2 sender:(id)arg3 { %log; _Bool r = %orig; HBLogDebug(@" = %d", r); return r; }
...
- (id)getRecentMessageWrapListForEmoticonRecommend { %log; id r = %orig; HBLogDebug(@" = %@", r); return r; }
- (void)shouldShowRelativeEmoticonViewControllerWithEmoticonWrap:(id)arg1 { %log; %orig; }
