...
@class AVCaptureDevice, AVCaptureSession, AVCaptureStillImageOutput, AVCaptureVideoDataOutput, EditImageAnimatedTextTool, EmoticonCameraFollowImageView, EmoticonCameraReportObject, EmoticonCameraResultView, MCFilterManager, MMCircularProgressView, MMSightRecordHelperView, MMSightRecordView, MMUIButton, NSObject, NSString, SightPreviewViewF3, StreamVoiceInputLogic, UIImageView, UIView;
