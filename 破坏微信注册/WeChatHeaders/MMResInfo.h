...
+ (void)__wcdb_MMResInfo_primary_28:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)arrSignatureDataInfo;
+ (void)__wcdb_MMResInfo_synthesize_27:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)clientVersion;
+ (void)__wcdb_MMResInfo_synthesize_26:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)resOriginalMd5;
+ (void)__wcdb_MMResInfo_synthesize_25:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)signatureData;
+ (void)__wcdb_MMResInfo_synthesize_24:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)reportId;
+ (void)__wcdb_MMResInfo_synthesize_23:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)sampleId;
+ (void)__wcdb_MMResInfo_synthesize_22:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)eid;
+ (void)__wcdb_MMResInfo_synthesize_21:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)isTemp;
+ (void)__wcdb_MMResInfo_synthesize_20:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)supportVersion;
+ (void)__wcdb_MMResInfo_synthesize_19:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)fileId;
+ (void)__wcdb_MMResInfo_synthesize_18:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)resSubType;
+ (void)__wcdb_MMResInfo_synthesize_17:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)isCompress;
+ (void)__wcdb_MMResInfo_synthesize_16:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)isEncrypt;
+ (void)__wcdb_MMResInfo_synthesize_15:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)chunkLength;
+ (void)__wcdb_MMResInfo_synthesize_14:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)resType;
+ (void)__wcdb_MMResInfo_synthesize_13:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)crc32;
+ (void)__wcdb_MMResInfo_synthesize_12:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)offset;
+ (void)__wcdb_MMResInfo_synthesize_11:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)size;
+ (void)__wcdb_MMResInfo_synthesize_10:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)accessTime;
+ (void)__wcdb_MMResInfo_synthesize_9:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)expireTime;
+ (void)__wcdb_MMResInfo_synthesize_8:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)createTime;
+ (void)__wcdb_MMResInfo_synthesize_7:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)localSubPath;
+ (void)__wcdb_MMResInfo_synthesize_6:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)version;
+ (void)__wcdb_MMResInfo_synthesize_5:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)domain;
+ (void)__wcdb_MMResInfo_synthesize_4:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)appId;
+ (void)__wcdb_MMResInfo_synthesize_3:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)resMd5;
+ (void)__wcdb_MMResInfo_synthesize_2:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)resUrlMd5;
+ (void)__wcdb_MMResInfo_synthesize_1:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)resInfoId;
+ (void)__wcdb_MMResInfo_synthesize_0:(struct WCTBinding *)arg1;
