...
@class MMDelegateProxy, MMLoadingView, MMNavBarInteractiveConfig, MMTitleView, MMUINavigationBar, NSMutableArray, NSMutableDictionary, NSString, UIBarButtonItem, UIColor, UILabel, UINavigationController, UIPanGestureRecognizer, UIView, WCEventTrackingSystemConfig;
