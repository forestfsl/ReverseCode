...
+ (void)__wcdb_MyWCDataItem_not_null_3:(struct WCTBinding *)arg1;
+ (void)__wcdb_MyWCDataItem_primary_2:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)m_maBuffer;
+ (void)__wcdb_MyWCDataItem_synthesize_1:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)m_maID;
+ (void)__wcdb_MyWCDataItem_synthesize_0:(struct WCTBinding *)arg1;
