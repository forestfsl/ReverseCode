...
+ (void)__wcdb_WADBContactTable_primary_8:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)appId;
+ (void)__wcdb_WADBContactTable_synthesize_7:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)headImageStatus;
+ (void)__wcdb_WADBContactTable_synthesize_6:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)wxAppOpt;
+ (void)__wcdb_WADBContactTable_synthesize_5:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)contactPack;
+ (void)__wcdb_WADBContactTable_synthesize_4:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)externalInfo;
+ (void)__wcdb_WADBContactTable_synthesize_3:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)brandIconURL;
+ (void)__wcdb_WADBContactTable_synthesize_2:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)type;
+ (void)__wcdb_WADBContactTable_synthesize_1:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)userName;
+ (void)__wcdb_WADBContactTable_synthesize_0:(struct WCTBinding *)arg1;
