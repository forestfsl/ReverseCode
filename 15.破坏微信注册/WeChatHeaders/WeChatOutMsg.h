...
+ (void)__wcdb_WeChatOutMsg_primary_12:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)reserve4;
+ (void)__wcdb_WeChatOutMsg_synthesize_11:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)reserve3;
+ (void)__wcdb_WeChatOutMsg_synthesize_10:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)reserve2;
+ (void)__wcdb_WeChatOutMsg_synthesize_9:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)reserve1;
+ (void)__wcdb_WeChatOutMsg_synthesize_8:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)pushTime;
+ (void)__wcdb_WeChatOutMsg_synthesize_7:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)content;
+ (void)__wcdb_WeChatOutMsg_synthesize_6:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)title;
+ (void)__wcdb_WeChatOutMsg_synthesize_5:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)wcoMsgType;
+ (void)__wcdb_WeChatOutMsg_synthesize_4:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)readStatus;
+ (void)__wcdb_WeChatOutMsg_synthesize_3:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)createTime;
+ (void)__wcdb_WeChatOutMsg_synthesize_2:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)svrID;
+ (void)__wcdb_WeChatOutMsg_synthesize_1:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)localID;
+ (void)__wcdb_WeChatOutMsg_synthesize_0:(struct WCTBinding *)arg1;
