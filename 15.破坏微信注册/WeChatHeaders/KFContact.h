...
+ (void)__wcdb_KFContact_primary_6:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)headImgUpdateFlag;
+ (void)__wcdb_KFContact_synthesize_5:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)updateTime;
+ (void)__wcdb_KFContact_synthesize_4:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)nickName;
+ (void)__wcdb_KFContact_synthesize_3:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)headImageUrl;
+ (void)__wcdb_KFContact_synthesize_2:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)brand;
+ (void)__wcdb_KFContact_synthesize_1:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)kfOpenId;
+ (void)__wcdb_KFContact_synthesize_0:(struct WCTBinding *)arg1;
