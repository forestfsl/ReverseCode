...
+ (void)__wcdb_WCOutRecentCallItem_primary_7:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)statusCode;
+ (void)__wcdb_WCOutRecentCallItem_synthesize_6:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)endTime;
+ (void)__wcdb_WCOutRecentCallItem_synthesize_5:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)startTime;
+ (void)__wcdb_WCOutRecentCallItem_synthesize_4:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)createTime;
+ (void)__wcdb_WCOutRecentCallItem_synthesize_3:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)phoneNum;
+ (void)__wcdb_WCOutRecentCallItem_synthesize_2:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)countryCode;
+ (void)__wcdb_WCOutRecentCallItem_synthesize_1:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)localID;
+ (void)__wcdb_WCOutRecentCallItem_synthesize_0:(struct WCTBinding *)arg1;
