...
+ (void)__wcdb_WCDBMigrationTagObject_synthesize_5:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)m_startTime;
+ (void)__wcdb_WCDBMigrationTagObject_synthesize_4:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)m_fileName;
+ (void)__wcdb_WCDBMigrationTagObject_synthesize_3:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)m_sessionName;
+ (void)__wcdb_WCDBMigrationTagObject_synthesize_2:(struct WCTBinding *)arg1;
