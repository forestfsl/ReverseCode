...
+ (void)__wcdb_WCAdvertiseLogDBItem_primary_4:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)m_nsLogExt;
+ (void)__wcdb_WCAdvertiseLogDBItem_synthesize_3:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)m_uiLogId;
+ (void)__wcdb_WCAdvertiseLogDBItem_synthesize_2:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)m_uiCreateTime;
+ (void)__wcdb_WCAdvertiseLogDBItem_synthesize_1:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)m_uiLocalId;
+ (void)__wcdb_WCAdvertiseLogDBItem_synthesize_0:(struct WCTBinding *)arg1;
