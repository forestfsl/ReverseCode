...
#import "MailRTEBaseAttachmentViewDelegate-Protocol.h"
#import "MailRTEToolViewDelegate-Protocol.h"
#import "MailReceiverEditViewDelegate-Protocol.h"
#import "RTEBaseTextViewDelegate-Protocol.h"
...
@class CMail, MMTableView, MMTimer, MailAttachmentControlView, MailContactFilterView, MailContentView, MailRTEToolView, MailReceiverEditView, MailSubjectEditView, NSMutableArray, NSString, NSTextStorage, UIView;

@interface WriteMailViewController : MMUIViewController <MailRTEToolViewDelegate, RTEBaseTextViewDelegate, MailRTEBaseAttachmentViewDelegate, UITableViewDelegate, UITableViewDataSource, UITextViewDelegate, WCActionSheetDelegate, UINavigationControllerDelegate, MailContactFilterViewDelegate, MailContentViewDelegate, UIAlertViewDelegate, IQQMailExt, MMMailContactSelectViewDelegate, MailReceiverEditViewDelegate, MailAttachmentControlViewDelegate, VerifyQQPwdMgrExt>
{
