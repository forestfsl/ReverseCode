...
+ (void)__wcdb_WCDBSessionTimeIntervalObject_synthesize_11:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)m_msgBeginTime;
+ (void)__wcdb_WCDBSessionTimeIntervalObject_synthesize_10:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)m_sessionName;
+ (void)__wcdb_WCDBSessionTimeIntervalObject_synthesize_9:(struct WCTBinding *)arg1;
