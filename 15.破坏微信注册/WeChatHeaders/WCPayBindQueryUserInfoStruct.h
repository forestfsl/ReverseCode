...
@class NSArray, NSString, WCPayBalanceInfo, WCPayBankPriority, WCPayBillEntryInfo, WCPayBindCardInfo, WCPayFetchInfo, WCPayJumpRemindInfo, WCPayLQTInfo, WCPayLoanEntryInfo, WCPayNoticeInfo, WCPayRealnameGuideInfo, WCPaySwitchInfo, WCPayUserInfo;
