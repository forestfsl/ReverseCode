...
+ (void)__wcdb_MMBaseSessionInfo_primary_12:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)jumpMsgLocalId;
+ (void)__wcdb_MMBaseSessionInfo_synthesize_11:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)outUnreadMsgTime;
+ (void)__wcdb_MMBaseSessionInfo_synthesize_10:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)sessionUnTopTime;
+ (void)__wcdb_MMBaseSessionInfo_synthesize_9:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)pbLastMessage;
+ (void)__wcdb_MMBaseSessionInfo_synthesize_8:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)sessionTopTime;
+ (void)__wcdb_MMBaseSessionInfo_synthesize_7:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)outUnreadCount;
+ (void)__wcdb_MMBaseSessionInfo_synthesize_6:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)sessionFlag;
+ (void)__wcdb_MMBaseSessionInfo_synthesize_5:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)draftMsgTime;
+ (void)__wcdb_MMBaseSessionInfo_synthesize_4:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)draftMsg;
+ (void)__wcdb_MMBaseSessionInfo_synthesize_3:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)lastMsgUpdateTime;
+ (void)__wcdb_MMBaseSessionInfo_synthesize_2:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)unreadCount;
+ (void)__wcdb_MMBaseSessionInfo_synthesize_1:(struct WCTBinding *)arg1;
+ (const struct WCTProperty *)sessionId;
+ (void)__wcdb_MMBaseSessionInfo_synthesize_0:(struct WCTBinding *)arg1;
